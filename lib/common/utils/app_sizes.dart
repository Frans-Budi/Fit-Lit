...
class AppSizes {
  ...
  static double paddingTop = Get.context!.mediaQueryPadding.top;
  static double paddingBottom = Get.context!.mediaQueryPadding.bottom;
  ...
  static Future setScreenAwareConstant(context) async {
    ...
    s400 = ScreenUtil().setWidth(430.0);
